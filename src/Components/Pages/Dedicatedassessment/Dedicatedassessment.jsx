          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-6 col-12">
              ...
              <p className="hard-skills-desc">
                ...
                analyzing results, or refining assessments to make better hiring
                decisions, your DAE provides hands-on assistance at every step.
                A DAE can help with:
              </p>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-6 col-12">
              ...
              <p className="hard-skills-desc">
                ...
                allowing applicants to record responses to targeted prompts, you
                gain insight into their verbal communication, confidence,
                situational awareness, and problem-solving skills—all in a
                single interactive experience. This method helps you understand
                how candidates present themselves and handle real-world
                scenarios that are most relevant to the role.
              </p>
              ...
              <ul className="skills-list">
                <li>
                  <div>
                    ...
                    <p>
                      ...
                      skills, helping you select the most qualified candidates.
                    </p>
                  </div>
                </li>
                ...
                <li>
                  <div>
                    ...
                    <p>
                      Leverage expert insights from pre-employment test results
                      to continuously refine and improve your assessments.
                    </p>
                  </div>
                </li>
                ...
                <li>
                  <div>
                    ...
                    <p>
                      Ensure a seamless and relevant skills testing process for
                      all applicants, maintaining fairness and clarity.
                    </p>
                  </div>
                </li>
